...
<div class="homad-projects-hub">
    ...
    <section class="homad-hero-small">
        <div class="homad-container">
            ...
            <a href="#quote-wizard" class="homad-btn homad-btn--primary">Solicitar Propuesta</a>
        </div>
    </section>
            ...
            <div class="homad-container">
                ...
                <div class="homad-packages-grid">
                    <div class="homad-package-card">
                        ...
                        <button class="homad-btn homad-btn--primary full-width" onclick="HomadApp.prefillQuote('package', 'Baño Nuevo')">Ver Packs</button>
                    </div>
                    ...
                    <div class="homad-package-card">
                        ...
                        <button class="homad-btn homad-btn--primary full-width" onclick="HomadApp.prefillQuote('package', 'Cocina Chef')">Ver Packs</button>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="homad-container">
                <div class="homad-b2b-banner">
                    <div class="b2b-content">
                        ...
                        <button class="homad-btn homad-btn--dark" onclick="HomadApp.prefillQuote('b2b', 'Developer Inquiry')">Cotizar B2B</button>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="homad-container">
                <div class="homad-wizard-wrapper">
                    ...
                    <form id="homad-lead-form" class="homad-form" action="<?php echo admin_url('admin-ajax.php'); ?>" method="POST">
                        ...
                        <button type="submit" class="homad-btn homad-btn--primary full-width">Enviar Solicitud Gratuita</button>
                    </form>
                </div>
            </div>
        </section>
