...
function skincare_enqueue_scripts() {
	...
	if ( skincare_is_f8_page() ) {
		...
		wp_enqueue_style( 'skincare-f8-base', $f8_css . '/base.css', ['skincare-f8-core'], $ver );
		wp_enqueue_style( 'skincare-f8-custom', $f8_css . '/custom.css', ['skincare-f8-base'], $ver );
		wp_enqueue_style( 'skincare-f8-glider', $f8_css . '/glider.min.css', ['skincare-f8-custom'], $ver );

		if ( is_page( ['korean', 'makeup'] ) ) {
			wp_enqueue_style( 'skincare-f8-collection-tile', $f8_css . '/collection-tile-controller.af177681.css', ['skincare-f8-custom'], $ver );
		}

		if ( is_page( 'vegan' ) ) {
			wp_enqueue_style( 'skincare-f8-vegan-form', $f8_css . '/vegan-form.css', ['skincare-f8-custom'], $ver );
		...
		if ( is_page( 'store-locator' ) ) {
			wp_enqueue_style( 'skincare-f8-locator-fonts', $f8_css . '/locator-fonts.css', ['skincare-f8-custom'], $ver );
