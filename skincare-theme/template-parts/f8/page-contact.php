<?php
/**
 * Reference markup from refs/f8/Cont.html.
 */
?>

<main id="MainContent" role="main" tabindex="-1">
      <section id="shopify-section-template--21252938006763__contact_form_xpMtb9" class="shopify-section"><div class="container-fluid pt-8 pb-6 lg:py-2">
...
<div class="contact-form pb-10 lg:pt-5 lg:pb-15">
    <div class="contact-form__title container flex justify-center flex-col items-center pb-10">
    ...
    <div class="container"><form method="post" action="https://www.skincupid.co.uk/contact#contact_form" id="contact_form" accept-charset="UTF-8" class="contact-form" data-np-intersection-state="visible"><input type="hidden" name="form_type" value="contact"><input type="hidden" name="utf8" value="✓">
            <div class="contact-form__fields lg:grid grid-cols-2 gap-x-8 gap-y-6 xl:max-w-[870px] mx-auto">
                            ...
                            <div class="contact-form__fields__field field--dropdown col-span-1 mb-[22px] lg:mb-0" data-field-id="reason-for-contacting-us">
                                <label class="block text-sm mb-[14px]" for="reason-for-contacting-us">
                                ...
                                <select name="contact[reason-for-contacting-us]" id="reason-for-contacting-us" class="w-full" required="" fdprocessedid="dnyw5" data-np-mark="1" data-np-intersection-state="observed">
                                    <option value="">Pick a reason</option>
                                        ...
                                        <option value="  Skincare or product information">  Skincare or product information</option>
                                    
                                </select>
                            </div>
                
<div class="contact-form__fields__field field--text col-span-1 mb-[22px] lg:mb-0" data-field-id="full-name">
                                <label class="block text-sm mb-[14px]" for="full-name">
                                    <span class="text-citron-primary inline-block mr-2">*</span>
                                    Full Name:
                                </label>
...
<div class="contact-form__fields__field field--text col-span-1 mb-[22px] lg:mb-0" data-field-id="email-address">
                                <label class="block text-sm mb-[14px]" for="email-address">
                                    <span class="text-citron-primary inline-block mr-2">*</span>
                                    Email Address:
                                </label>
...
<div class="contact-form__fields__field field--text col-span-1 mb-[22px] lg:mb-0" data-field-id="order-number">
                                <label class="block text-sm mb-[14px]" for="order-number">
...
<div class="contact-form__fields__field field--textarea col-span-2 mb-[22px] lg:mb-0" data-field-id="message">
                                <label class="block text-sm mb-[14px]" for="message">
                                    <span class="text-citron-primary inline-block mr-2">*</span>
                                    Message
                                </label>
                ...
                <div class="col-span-2 flex justify-center mt-6">
                    <button type="submit" class="btn btn-primary btn-lg" pa-marked="1" fdprocessedid="xa8z1r">
                        Submit
    ...
    <path id="Vector 8" d="M9.22498 0.975098L14.725 6.4751L9.22498 11.9751" stroke="currentColor" stroke-width="1.2"></path>
...
</section><section id="shopify-section-template--21252938006763__embed_content_Yen8Cx" class="shopify-section"><div class="embed-content block w-full px-5 lg:px-10 xl:px-15">
        ...
        <flickity-scroll data-delay="1" data-auto-play="true" data-pause="false">
            ...
            <div class="flickity-viewport" style="height: 90px; touch-action: pan-y;"><div class="flickity-slider" style="left: 0px; transform: translateX(-237.19%);"><div class="top-section-border-inner-wrapper is-selected" style="position: absolute; left: 0px; transform: translateX(0%);">
...
#kbeauty #koreanskincare #lipoil #glossylips #lipglosslover #juicylips #lipcare #lipcareproducts" data-ll-status="loaded" class="entered loaded" src="./Cont_files/18030693905520415_thumb.jpg">
 ...
 <path class="icon-color" d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"></path>
    ...
    <style data-shopify="">
        #shopify-section-template--21252938006763__embed_content_Yen8Cx {
            padding-bottom: 40px;
            padding-top: 40px;
            background-color:#fff0ee;
        }
        
        #shopify-section-template--21252938006763__embed_content_Yen8Cx flickity-scroll svg {
