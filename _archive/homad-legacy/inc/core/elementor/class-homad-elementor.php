...
class Homad_Elementor_Extension {
    ...
    public function frontend_styles() {
        wp_register_style( 'homad-elementor', get_stylesheet_directory_uri() . '/assets/core/css/homad-elementor.css', [], '1.0.0' );
        wp_enqueue_style( 'homad-elementor' );
    }

    public function frontend_scripts() {
        wp_register_script( 'homad-elementor', get_stylesheet_directory_uri() . '/assets/core/js/homad-elementor.js', ['jquery'], '1.0.0', true );
