<?php
/**
 * Reference markup from refs/f8/Wis.html.
 */
?>

<main id="MainContent" role="main" tabindex="-1">
      <section id="shopify-section-template--21252933681387__account_header_iegfCm" class="shopify-section"><div class="login-header block w-full lg:px-10 xl:px-15">
    <div class="login-header-inner block max-w-5.5xl w-full mx-auto relative py-10" style="background:#ffd9d4;">
        <div class="login-header-content flex flex-col gap-4 px-5 lg:px-10 xl:px-15 relative">
            
            
                <h2 class="h1 text-center font-extrabold" style="color:#0f3062;">Hello, !</h2>
            
            
            
                <div class="flex flex-wrap items-center justify-center" style="color:#0f3062;">
                    <div class="js-lion-points">
<span data-lion-points="approved"></span>
    ...
    <path id="Vector 8" d="M9.22498 0.975098L14.725 6.4751L9.22498 11.9751" stroke="currentColor" stroke-width="1.2"></path>
        ...
        <div class="account-header-links js-grab-scroll grab-scroll lg:!cursor-auto gap-6 lg:gap-10 flex justify-start sm:justify-center items-stretch overflow-x-auto snap-x snap-mandatory p-5 scroll-p-5 cursor-grab">
    ...
    <style data-shopify="">
        #shopify-section-template--21252933681387__account_header_iegfCm {
            padding-bottom: 0px;
            padding-top: 0px;
        }
        #shopify-section-template--21252933681387__account_header_iegfCm .section-icon-wrapper {
            position: absolute;
            bottom: -32px;
            left: 5%;
        }
        #shopify-section-template--21252933681387__account_header_iegfCm .account-header-link::after {
            background:#e3dd71;
        }
        @media screen and (min-width: 1024px) {
            ...
            #shopify-section-template--21252933681387__account_header_iegfCm .login-header-inner {
                border-radius:70px;
            }
        }
    </style>
...
</section><div id="shopify-section-template--21252933681387__172379132764c04e3a" class="shopify-section">
  
    <div id="shopify-block-AR1pIdCs0NndEdkhSW__wishlist_king_wishlist_page_block_6LNjMe" class="shopify-block shopify-app-block"><wishlist-page data-wishlist-id="mine" wk-loaded=""><!---->
        <section class="wk-page notranslate">
          <!--?lit$321280441$-->
        <div class="wk-header">
          <h1 class="wk-title">
            <!--?lit$321280441$-->Wishlist
          </h1>
        ...
        <div class="wk-controls">
          <!--?lit$321280441$-->
              <wishlist-share data-wishlist-id="mine" wk-loaded=""><!---->
        <wk-button><!---->
      <button type="button" aria-label="Share wishlist" class="wk-button wk-align-center wk-align-content-center" fdprocessedid="6aw9md">
        <!--?lit$321280441$-->
      <wk-icon class="wk-icon" icon="share"><!---->
    <svg viewBox="0 0 24 24">
      <path d="M20 13v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6M12 15V3m0 0L8.5 6.5M12 3l3.5 3.5" fill="none" stroke-linecap="round" stroke-linejoin="round"></path>
    </svg>
  </wk-icon>
    <!--?lit$321280441$--><span class="wk-text"><!--?lit$321280441$-->Share wishlist</span><!--?lit$321280441$-->
      </button>
    </wk-button>
      </wishlist-share>
          ...
          <div class="wk-body"><!--?lit$321280441$-->
        <div class="wk-grid">
          <!--?lit$321280441$--><!---->
              <wishlist-product-card data-wishlist-id="mine" data-wishlist-item-id="6956d6caeffbd8b3ffd912dd" wk-loaded=""><!---->
        <div class="wk-product-card" style="display: block;" data-wishlist-card="6999714332862">
  ...
  <span data-quick-view-text="">Quick View</span>
    ...
    <div class="flex flex-col gap-2.5 pt-5 h-full">
      ...
      <div class="flex flex-col gap-2 -mt-1 product-card-reviews min-h-[23px]">
        <div class="jdgm-widget jdgm-preview-badge" data-widget-name="preview_badge" data-impressions-tracked="true" data-views-tracked="true">
...
<button data-quick-view-trigger="" class="lg:hidden relative bg-melon-primary flex items-center justify-center text-center gap-2 text-xs p-2 rounded-full" type="button" data-product-handle="dr-ceuracle-vegan-kombucha-tea-essence">
  <svg width="17" height="11" viewBox="0 0 17 11" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10.4605 3.05901C9.76472 2.92077 9.2145 3.23901 9.0902 3.83744C8.97236 4.40555 9.32809 4.95943 9.88921 5.08122C10.5098 5.21595 10.9917 4.84725 11.1699 4.10135C11.6265 5.02227 11.4627 6.6366 10.1766 7.55272C8.92434 8.44481 7.166 8.19106 6.22108 6.98239C5.26304 5.7569 5.42779 3.99878 6.59897 2.99063C7.81042 1.94773 9.50042 2.13125 10.4605 3.05919V3.05901Z" fill="#0F3062"></path>
    <path d="M16.3349 5.22673C15.995 4.616 15.5907 4.05114 15.1185 3.53302C12.9885 1.19543 9.69324 0.139132 6.59565 0.837213C3.97158 1.42858 2.00014 2.90206 0.672524 5.21484C0.610535 5.32291 0.611051 5.40652 0.663226 5.51341C0.935809 6.07113 1.26418 6.59061 1.64008 7.06659C1.69708 7.13881 1.75545 7.21001 1.81469 7.28036C1.82519 7.29294 1.83587 7.30551 1.84654 7.31792C3.47739 9.23 5.89981 10.3755 8.50545 10.375C8.97295 10.3731 9.43839 10.3425 9.89781 10.2651C10.0039 10.2472 10.1094 10.2268 10.2148 10.2037C13.0119 9.58991 15.0557 8.0194 16.3413 5.49013C16.3887 5.397 16.3857 5.31816 16.3349 5.22673Z" stroke="#0F3062" stroke-width="0.580263" stroke-miterlimit="10"></path>
  </svg>
...
<input type="hidden" name="product-id" value="6999714332862"></form>
  ...
  <div class="js-custom-wishlist-button-wrapper z-[2] absolute top-2.5 right-2.5 rounded-full bg-white shadow-sm hidden items-center justify-center w-7 h-7" data-handle="dr-ceuracle-vegan-kombucha-tea-essence" style="display: block;" wk-skip=""><remove-button data-wishlist-item-id="6956d6caeffbd8b3ffd912dd" show-icon=""><!---->
        <wk-button class="wk-floating" style="position: absolute; top: 0px; left: 0px; transition: none; transform: translate3d(-10px, -10px, 0px);"><!---->
      <button type="button" aria-label="Remove" class="wk-button wk-align-center wk-align-content-center" fdprocessedid="jrmgcr">
        <!--?lit$321280441$-->
      <wk-icon class="wk-icon" icon="remove"><!---->
    <svg viewBox="0 0 64 64">
      <path d="M0.309,0.309a0.9,0.9,0,0,1,1.268,0L63.691,62.423a0.9,0.9,0,0,1-1.268,1.268L0.309,1.577A0.9,0.9,0,0,1,.309.309Z"></path>
      <path d="M63.691,0.309a0.9,0.9,0,0,1,0,1.268L1.577,63.691A0.9,0.9,0,0,1,.309,62.423L62.423,0.309A0.9,0.9,0,0,1,63.691.309Z"></path>
    </svg>
  </wk-icon>
    <!--?lit$321280441$--><!--?lit$321280441$-->
      </button>
    </wk-button>
      </remove-button><wishlist-button-product data-product-handle="dr-ceuracle-vegan-kombucha-tea-essence" show-icon="" icon="wishlist" full-width="" align-self="center" align-content="center" wk-loaded=""><!---->
        <wk-button><!---->
      <button type="button" aria-label="In Wishlist" class="wk-button wk-align-center wk-align-content-center wk-selected wk-full-width">
        <!--?lit$321280441$-->
    ...
    <!--?lit$321280441$--><!--?lit$321280441$-->
...
</div><section id="shopify-section-template--21252933681387__embed_content_cWpe68" class="shopify-section"><div class="embed-content block w-full px-5 lg:px-10 xl:px-15">
        ...
        <flickity-scroll data-delay="1" data-auto-play="true" data-pause="false">
            ...
            <div class="flickity-viewport" style="height: 90px; touch-action: pan-y;"><div class="flickity-slider" style="left: 0px; transform: translateX(-120.48%);"><div class="top-section-border-inner-wrapper is-selected" style="position: absolute; left: 0px; transform: translateX(0%);">
    ...
    <style data-shopify="">
        #shopify-section-template--21252933681387__embed_content_cWpe68 {
            padding-bottom: 0px;
            padding-top: 0px;
            background-color:#fff0ee;
        }
        
        #shopify-section-template--21252933681387__embed_content_cWpe68 flickity-scroll svg {
