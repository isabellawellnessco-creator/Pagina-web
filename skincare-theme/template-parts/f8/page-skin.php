<?php
/**
 * Reference markup from refs/f8/Skin.html.
 */
?>

<main id="MainContent" role="main" tabindex="-1">
      <div id="shopify-section-template--21252938072299__breadcrumbs_FkWN9b" class="shopify-section"><div class="breadcrumbs-section pb-5 pt-2 px-5 lg:px-10 xl:px-15" style="background-color:#fdfcfb;">
...
<li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
    ...
    <style data-shopify="">
        #shopify-section-template--21252938072299__breadcrumbs_FkWN9b .breadcrumbs-wrapper ol {
  ...
  </div><section id="shopify-section-template--21252938072299__press_nCqqmN" class="shopify-section"><div class="press-section block w-full container-fluid" style="background:#fdfcfb;">
    <div class="press-inner block container !px-0 relative">
        <div class="press-content flex flex-col gap-2.5 lg:gap-5 relative max-w-2xl mx-auto">
            
            
                <h2 class="h1 text-center font-medium" style="color:#0f3062;"><strong>Skin Cupid Press</strong></h2>
            
            
                <p class="text-center font-normal text-base" style="color:#0f3062;">Discover the must-have products that have caught the eye of top magazines!
            
        </p></div>
                <div class="press-articles mt-18 lg:mt-25 flex flex-col gap-10 lg:gap-20 xl:gap-25">
    ...
    <path id="Vector 8" d="M9.22498 0.975098L14.725 6.4751L9.22498 11.9751" stroke="currentColor" stroke-width="1.2"></path>
                    ...
                    <div class="press-products w-full max-lg:border-b max-lg:pb-10 lg:px-5 lg:border-l border-pink-mid_dark lg:w-[30%] grow-0 relative" x-data="{ activeSlide: 1 }" x-effect="if(activeSlide == 1){ $refs.prev.setAttribute(&#39;disabled&#39;, &#39;&#39;) } else { $refs.prev.removeAttribute(&#39;disabled&#39;) }; if(activeSlide == 1) { $refs.next.setAttribute(&#39;disabled&#39;, &#39;&#39;) } else { $refs.next.removeAttribute(&#39;disabled&#39;) }">
                        <h3 class="font-medium capitalize text-center mb-10">Featured Products</h3>
                        <div class="snap-x snap-mandatory flex flex-row overflow-x-auto hidden-scroll scroll-smooth">
                            
                                
                                    <div class="w-full snap-start shrink-0" x-ref="pressProduct1">
...
<button data-quick-view-trigger="" class="lg:hidden relative bg-melon-primary flex items-center justify-center text-center gap-2 text-xs p-2 rounded-full" type="button" data-product-handle="roundlab-1025-dokdo-toner-100ml-200ml-1" pa-marked="1">
  <svg width="17" height="11" viewBox="0 0 17 11" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10.4605 3.05901C9.76472 2.92077 9.2145 3.23901 9.0902 3.83744C8.97236 4.40555 9.32809 4.95943 9.88921 5.08122C10.5098 5.21595 10.9917 4.84725 11.1699 4.10135C11.6265 5.02227 11.4627 6.6366 10.1766 7.55272C8.92434 8.44481 7.166 8.19106 6.22108 6.98239C5.26304 5.7569 5.42779 3.99878 6.59897 2.99063C7.81042 1.94773 9.50042 2.13125 10.4605 3.05919V3.05901Z" fill="#0F3062"></path>
    <path d="M16.3349 5.22673C15.995 4.616 15.5907 4.05114 15.1185 3.53302C12.9885 1.19543 9.69324 0.139132 6.59565 0.837213C3.97158 1.42858 2.00014 2.90206 0.672524 5.21484C0.610535 5.32291 0.611051 5.40652 0.663226 5.51341C0.935809 6.07113 1.26418 6.59061 1.64008 7.06659C1.69708 7.13881 1.75545 7.21001 1.81469 7.28036C1.82519 7.29294 1.83587 7.30551 1.84654 7.31792C3.47739 9.23 5.89981 10.3755 8.50545 10.375C8.97295 10.3731 9.43839 10.3425 9.89781 10.2651C10.0039 10.2472 10.1094 10.2268 10.2148 10.2037C13.0119 9.58991 15.0557 8.0194 16.3413 5.49013C16.3887 5.397 16.3857 5.31816 16.3349 5.22673Z" stroke="#0F3062" stroke-width="0.580263" stroke-miterlimit="10"></path>
  </svg>
...
<form method="post" action="https://www.skincupid.co.uk/cart/add" id="product-card-form-7985614356715" accept-charset="UTF-8" class="product-card-form" enctype="multipart/form-data" novalidate="novalidate" data-type="add-to-cart-form"><input type="hidden" name="form_type" value="product"><input type="hidden" name="utf8" value="✓"><input type="hidden" class="selected-variant-id" name="id" value="43726835777771">
    ...
    <span class="sr-only">Loading...</span>
      ...
      </button><input type="hidden" name="product-id" value="7985614356715"><input type="hidden" name="section-id" value="template--21252938072299__press_nCqqmN"></form>
  ...
  <div class="js-custom-wishlist-button-wrapper z-[2] absolute top-2.5 right-2.5 rounded-full bg-white shadow-sm hidden items-center justify-center w-7 h-7" data-handle="roundlab-1025-dokdo-toner-100ml-200ml-1" wk-skip=""><wishlist-button-product data-product-handle="roundlab-1025-dokdo-toner-100ml-200ml-1" show-icon="" icon="wishlist" full-width="" align-self="center" align-content="center" wk-loaded=""><!---->
        <wk-button><!---->
      <button type="button" aria-label="Add to Wishlist" class="wk-button wk-align-center wk-align-content-center wk-full-width" fdprocessedid="cn3rqp">
        <!--?lit$093202529$-->
...
<button data-quick-view-trigger="" class="hidden lg:flex absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 group-hover:pointer-events-auto pointer-events-none z-10 transition-opacity p-2 justify-center text-center text-[14px] rounded-full bg-white w-[160px] text-secondary gap-2 items-center" type="button" data-product-handle="nacific-fresh-herb-origin-serum-50ml" pa-marked="1">
  <svg width="17" height="11" viewBox="0 0 17 11" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10.4605 3.05901C9.76472 2.92077 9.2145 3.23901 9.0902 3.83744C8.97236 4.40555 9.32809 4.95943 9.88921 5.08122C10.5098 5.21595 10.9917 4.84725 11.1699 4.10135C11.6265 5.02227 11.4627 6.6366 10.1766 7.55272C8.92434 8.44481 7.166 8.19106 6.22108 6.98239C5.26304 5.7569 5.42779 3.99878 6.59897 2.99063C7.81042 1.94773 9.50042 2.13125 10.4605 3.05919V3.05901Z" fill="#0F3062"></path>
    <path d="M16.3349 5.22673C15.995 4.616 15.5907 4.05114 15.1185 3.53302C12.9885 1.19543 9.69324 0.139132 6.59565 0.837213C3.97158 1.42858 2.00014 2.90206 0.672524 5.21484C0.610535 5.32291 0.611051 5.40652 0.663226 5.51341C0.935809 6.07113 1.26418 6.59061 1.64008 7.06659C1.69708 7.13881 1.75545 7.21001 1.81469 7.28036C1.82519 7.29294 1.83587 7.30551 1.84654 7.31792C3.47739 9.23 5.89981 10.3755 8.50545 10.375C8.97295 10.3731 9.43839 10.3425 9.89781 10.2651C10.0039 10.2472 10.1094 10.2268 10.2148 10.2037C13.0119 9.58991 15.0557 8.0194 16.3413 5.49013C16.3887 5.397 16.3857 5.31816 16.3349 5.22673Z" stroke="#0F3062" stroke-width="0.580263" stroke-miterlimit="10"></path>
  </svg>
...
<button data-quick-view-trigger="" class="lg:hidden relative bg-melon-primary flex items-center justify-center text-center gap-2 text-xs p-2 rounded-full" type="button" data-product-handle="nacific-fresh-herb-origin-serum-50ml" pa-marked="1">
  <svg width="17" height="11" viewBox="0 0 17 11" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10.4605 3.05901C9.76472 2.92077 9.2145 3.23901 9.0902 3.83744C8.97236 4.40555 9.32809 4.95943 9.88921 5.08122C10.5098 5.21595 10.9917 4.84725 11.1699 4.10135C11.6265 5.02227 11.4627 6.6366 10.1766 7.55272C8.92434 8.44481 7.166 8.19106 6.22108 6.98239C5.26304 5.7569 5.42779 3.99878 6.59897 2.99063C7.81042 1.94773 9.50042 2.13125 10.4605 3.05919V3.05901Z" fill="#0F3062"></path>
    <path d="M16.3349 5.22673C15.995 4.616 15.5907 4.05114 15.1185 3.53302C12.9885 1.19543 9.69324 0.139132 6.59565 0.837213C3.97158 1.42858 2.00014 2.90206 0.672524 5.21484C0.610535 5.32291 0.611051 5.40652 0.663226 5.51341C0.935809 6.07113 1.26418 6.59061 1.64008 7.06659C1.69708 7.13881 1.75545 7.21001 1.81469 7.28036C1.82519 7.29294 1.83587 7.30551 1.84654 7.31792C3.47739 9.23 5.89981 10.3755 8.50545 10.375C8.97295 10.3731 9.43839 10.3425 9.89781 10.2651C10.0039 10.2472 10.1094 10.2268 10.2148 10.2037C13.0119 9.58991 15.0557 8.0194 16.3413 5.49013C16.3887 5.397 16.3857 5.31816 16.3349 5.22673Z" stroke="#0F3062" stroke-width="0.580263" stroke-miterlimit="10"></path>
  </svg>
...
<input type="hidden" name="product-id" value="7804747088107"><input type="hidden" name="section-id" value="template--21252938072299__press_nCqqmN"></form>
  ...
  <div class="js-custom-wishlist-button-wrapper z-[2] absolute top-2.5 right-2.5 rounded-full bg-white shadow-sm hidden items-center justify-center w-7 h-7" data-handle="nacific-fresh-herb-origin-serum-50ml" wk-skip=""><wishlist-button-product data-product-handle="nacific-fresh-herb-origin-serum-50ml" show-icon="" icon="wishlist" full-width="" align-self="center" align-content="center" wk-loaded=""><!---->
        <wk-button><!---->
      <button type="button" aria-label="Add to Wishlist" class="wk-button wk-align-center wk-align-content-center wk-full-width" fdprocessedid="mryqis">
        <!--?lit$093202529$-->
      <wk-icon class="wk-icon" icon="wishlist"><!---->
    <svg viewBox="0 0 64 64">
      <path d="M32.012,59.616c-1.119-.521-2.365-1.141-3.707-1.859a79.264,79.264,0,0,1-11.694-7.614C6.316,42,.266,32.6.254,22.076,0.244,12.358,7.871,4.506,17.232,4.5a16.661,16.661,0,0,1,11.891,4.99l2.837,2.889,2.827-2.9a16.639,16.639,0,0,1,11.874-5.02h0c9.368-.01,17.008,7.815,17.021,17.539,0.015,10.533-6.022,19.96-16.312,28.128a79.314,79.314,0,0,1-11.661,7.63C34.369,58.472,33.127,59.094,32.012,59.616Z"></path>
    ...
    <style data-shopify="">
        #shopify-section-template--21252938072299__press_nCqqmN {
            padding-bottom: 40px;
            padding-top: 40px;
        }
        #shopify-section-template--21252938072299__press_nCqqmN .press-card picture img {
            aspect-ratio:8/11;
        }
...
</section><section id="shopify-section-template--21252938072299__embed_content_Yen8Cx" class="shopify-section"><div class="embed-content block w-full px-5 lg:px-10 xl:px-15">
        ...
        <flickity-scroll data-delay="1" data-auto-play="true" data-pause="false">
            ...
            <div class="flickity-viewport" style="height: 90px; touch-action: pan-y;"><div class="flickity-slider" style="left: 0px; transform: translateX(-190.2%);"><div class="top-section-border-inner-wrapper is-selected" style="position: absolute; left: 0px; transform: translateX(0%);">
...
#kbeauty #koreanskincare #lipoil #glossylips #lipglosslover #juicylips #lipcare #lipcareproducts" data-ll-status="loaded" class="entered loaded" src="./Skin_files/18030693905520415_thumb.jpg">
 ...
 <path class="icon-color" d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"></path>
    ...
    <style data-shopify="">
        #shopify-section-template--21252938072299__embed_content_Yen8Cx {
            padding-bottom: 54px;
            padding-top: 0px;
            background-color:#fff0ee;
        }
        
        #shopify-section-template--21252938072299__embed_content_Yen8Cx flickity-scroll svg {
